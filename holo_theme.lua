...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --memicon,
            --memwidget,
			--wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox
			--    .layout.align.horizontal }, dpi(0), dpi(2), dpi(2), dpi(2), dpi(2), dpi(2)), "#303030"),
            cpu_icon,
            cpuwidget,
            bottom_bar,
            calendar_icon,
    ...
    s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, border_width = dpi(0), height = dpi(25) })
    ...
    s.mybottomwibox:setup {
        ...
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
			wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox
			    .layout.align.horizontal }, dpi(0), dpi(5)), "#303030"),
            --spr_bottom_right,
            --netdown_icon,
            --networkwidget,
            --netup_icon,
